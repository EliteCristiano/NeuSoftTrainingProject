  ...
  methods: {
    ...
    handlePay(index, row) {
      ...
      getSha({
        ...
        this.form.receiver = res.data.orReceiver
        this.form.address = res.data.orAddress
        this.form.state = res.data.orState
        this.form.city = res.data.orCity
        this.form.phone = res.data.orPhone
        this.form.postcode = res.data.orPostCode
        this.form.shipfee = res.data.orShipfee
        this.$message({
          type: 'success',
          showClose: true,
    ...
    handleView(index, row) {
      ...
      getOrderDetail({
        ...
        this.Form.proID = res.data.pro_ID
        this.Form.shipNumber = res.data.ship_Number
        this.Form.shipCompany = res.data.ship_Company
        this.$message({
          type: 'success',
          showClose: true,
          message: '亲~这是该订单的详情哦'
